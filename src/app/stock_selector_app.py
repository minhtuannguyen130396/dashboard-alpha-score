...
Modern tkinter UI for charting and data management.
...
from src.reporting.chart_runner import run_chart
...
def create_stock_selector_app():
    ...
    def _btn_run_chart():
        ...
        _set_status(f"⏳ Charting {sym} ...", CLR["warning"])
        _run_in_thread(
            lambda: run_chart(sym, start_date, end_date),
